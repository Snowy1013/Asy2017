package com.snowy.sample.primary.contacts;
...
import com.snowy.sample.AsyDeviceAdminReceiver;
 ...
 */
public class ContactsDemoActivity extends MasterFragment implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.ac_contacts_demo;
    }
    ...
    protected void onCreate2(View contentView, @Nullable Bundle savedInstanceState) {
        ...
        componentName = new ComponentName(getActivity(), AsyDeviceAdminReceiver.class);
