 ...
 */
public class TweenAnimateActivity extends MasterFragment implements View.OnClickListener{
    ...
    protected int getLayoutId() {
        return R.layout.ac_tween_animate;
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btn_alpha_animate: //透明度变化
                ...
                Animation alphaAnimation2 = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_animate);
            ...
            case R.id.btn_scale_animate://尺寸缩放
                ...
                //方法二在xml中定义
                Animation scaleAnimation2 = AnimationUtils.loadAnimation(getContext(), R.anim.scale_animate);
            ...
            case R.id.btn_translate_animate://位置移动
                ...
                //方法二在xml中定义
                Animation tranlateAnimation2 = AnimationUtils.loadAnimation(getContext(), R.anim.translate_animate);
            ...
            case R.id.btn_rotate_animate://旋转
                ...
                //方法二在xml中定义
                Animation rotateAnimation2 = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_animate);
            ...
            case R.id.btn_tweenmix_animate://混合效果
                ...
                Animation alphaAnimation3 = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_animate);
                animationSet.addAnimation(alphaAnimation3);
                Animation scaleAnimation3 = AnimationUtils.loadAnimation(getContext(), R.anim.scale_animate);
                animationSet.addAnimation(scaleAnimation3);
                Animation tranlateAnimation3 = AnimationUtils.loadAnimation(getContext(), R.anim.translate_animate);
                animationSet.addAnimation(tranlateAnimation3);
                Animation rotateAnimation3 = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_animate);
