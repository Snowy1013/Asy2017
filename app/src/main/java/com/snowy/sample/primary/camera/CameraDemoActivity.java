package com.snowy.sample.primary.camera;
...
public class CameraDemoActivity extends MasterFragment implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.ac_camera_demo;
    }
    ...
    protected void onCreate2(View contentView, @Nullable Bundle savedInstanceState) {
        ...
        vv_take_video = (VideoView) findViewById(R.id.vv_take_video);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE) {
            ...
            //设置视频控制器
            vv_take_video.setMediaController(new MediaController(getContext()));
            //播放完成回调
            vv_take_video.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
