...
import com.snowy.sample.uicode.adapter.AppAdapter;
...
public class GridViewMainActivity extends MasterFragment implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.ac_uicode_gridview_main;
    }

    @Override
    protected void onCreate2(View contentView, @Nullable Bundle savedInstanceState) {
        gv_ui_gridview = (GridView) findViewById(R.id.gv_ui_gridview);
    }
