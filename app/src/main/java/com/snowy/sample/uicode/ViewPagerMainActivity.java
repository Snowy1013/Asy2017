...
import com.snowy.sample.uicode.adapter.MyViewPagerAdapter;
 ...
 */
public class ViewPagerMainActivity extends MasterFragment {
    ...
    protected int getLayoutId() {
        return R.layout.ac_viewpager_main;
    }
...
//        initListView();
    ...
    public void initPullToRfreshListView() {
        ...
        listViewAdapter = new ArrayAdapter<String>(getContext(), R.layout.draw_list_item, R.id.draw_list_text, planetTitles);//创建Adapter对象
...
//        draw_left_ptrListView.setAdapter(listViewAdapter);
        ...
        draw_left_ptrListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(getContext(), "I'm " + planetTitles.get(position - 1), Toast.LENGTH_SHORT).show();
...
//        getActivity().getActionBar().setDisplayHomeAsUpEnabled(true); //给home-icon的左边加上一个返回的图标
//        getActivity().getActionBar().setHomeButtonEnabled(true); //使home-icon可点击
