package com.snowy.sample.opensource.rxjava;
 ...
 */
public class RxJavaDemoActivity extends MasterFragment implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.ac_rxjava_demo;
    }

    @Override
    protected void onCreate2(View contentView, @Nullable Bundle savedInstanceState) {
        mRootView = (LinearLayout) findViewById(R.id.rxjava_rootview);
        ...
        mThreadButton = (Button) findViewById(R.id.bt_rxjava_mainthread);
        mThreadButton.setOnClickListener(this);
        mAsyncButton = (Button) findViewById(R.id.bt_rxjava_asyncthread);
        mAsyncButton.setOnClickListener(this);
        mRxButton = (Button) findViewById(R.id.bt_rxjava_rx);
        mRxButton.setOnClickListener(this);

        iv_rxjava_imgshow = (ImageView) findViewById(R.id.iv_rxjava_imgshow);
